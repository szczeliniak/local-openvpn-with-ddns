...
echo $CLOUDFLARE_A_RECORD_NAME

auth_email=$CLOUDFLARE_EMAIL                        # The email used to login 'https://dash.cloudflare.com'
auth_method="token"                                 # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key=$CLOUDFLARE_TOKEN                          # Your API Token or Global API Key
zone_identifier=$CLOUDFLARE_ZONE_ID                 # Can be found in the "Overview" tab of your domain
record_name=$CLOUDFLARE_A_RECORD_NAME               # Which record you want to be synced
